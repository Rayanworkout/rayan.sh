      ...
      <div class="row">
        <div class="col-md-4">
          <div class="head">
            ...
            <a href="https://github.com/Rayanworkout" class="my-5 github-logo" target="_blank"><svg
                xmlns="http://www.w3.org/2000/svg" width="45" height="50" fill="currentColor" class="bi bi-github"
                viewBox="0 0 16 16">
                <path
